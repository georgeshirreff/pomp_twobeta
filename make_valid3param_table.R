...
ranges[["t_inflect"]] = rep(x = as.Date("2020-03-17"), NVALS) %>% as.Date(origin = "1970-01-01")
...
tab[["start:t_init"]] = ranges[["t_init"]]
tab[["start:t_inflect"]] = ranges[["t_inflect"]]

tab %>% summary

tab %>% write_csv("~/Pasteur/tars/input/validation/validation_table_3param.csv")
