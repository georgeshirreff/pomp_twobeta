...
tab[["start:t_inflect"]] = sample(tab[["true:t_inflect"]]) #set random starting points, which are just the true values randomly resampled

tab %>% write_csv("~/Pasteur/tars/input/validation/validation_table_4paramv2.csv")
