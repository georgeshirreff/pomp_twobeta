...
experiment_name = "posneg ALLward Inflect beta1profile Einit1 ABStrans tinflect23"
  ...
  for(i in 1:NTESTS){
    ...
    seirInflect %>% 
      mif2(params = seirInflect@params %>% replace(c("beta1", "beta2", "t_inflect", "t_init", "E_init"), c(start_beta1, start_beta2, start_tinflect, start_tinit, start_Einit))
           ...
           , partrans = parameter_trans(toEst = Csnippet("\tT_beta2 = beta2;")
                                        , fromEst = Csnippet("\tbeta2 = fabs(T_beta2);"))
