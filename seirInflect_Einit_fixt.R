...
# b = 1
  ...
  for(i in 1:NTESTS){
    ...
    # start_tinflect = "2020-03-22" %>% as.Date %>% as.numeric
    ...
    res %>% write_csv(paste0("output/seirInflect_", experiment_name, "_startbeta1", start_beta1, "_startbetafactor", start_betafactor, "_startEinit", start_Einit , ".csv"))
