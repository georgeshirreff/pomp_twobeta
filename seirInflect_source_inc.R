  ...
  pomp(t0 = posneg$Date[1]
       ...
       , rprocess=gillespie_hl(
         ...
         initEfromS = list("rate = (floor(t) == nearbyint(t_init)-1 & nearbyint(E_toInfect) > 0.1) ? 1e6*S : 0;"
                           , c(S=-1, E=+1, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect=-1, SAR_numer=+1, SAR_denom= 0, Ninfected=+1, AToday= 0, DDToday= 0, DailyInc = +1, Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         ...
         , StoE = list("double beta = t < t_inflect ? beta1 : beta2;
                       ...
                       , c(S=-1, E=+1, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer=+1, SAR_denom= 0, Ninfected=+1, AToday= 0, DDToday= 0, DailyInc = +1, Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         , EtoEs = list("rate = psi*alpha*E;"
                        , c(S= 0, E=-1, Es=+1, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected= 0, AToday= 0, DDToday= 0, DailyInc = 0, Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         ...
         , IstoRp = list("rate = delta*Is;"
                         , c(S= 0, E= 0, Es= 0, Ea= 0, Is=-1, Ia= 0, Rp=+1, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday= 0, DailyInc = 0, Undetected =+1, E_untested_dis = 0, sympt_untested_rec =+1, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         , IatoRp = list("rate = kappa3*delta*Ia;"
                         , c(S= 0, E= 0, Es= 0, Ea= 0, Is= 0, Ia=-1, Rp=+1, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday= 0, DailyInc = 0, Undetected =+1, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec =+1, asympt_untested_dis = 0, retest = 0))
         ...
         , IaTtoRpT = list("rate = kappa3*delta*IaT;"
                           , c(S= 0, E= 0, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT=-1, RpT=+1, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday= 0, DailyInc = 0, Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         ...
         , Eretest = list("rate = tomorrows_tests - NToday > 0 ? phi*ET*1e6 : 0;"
                          , c(S= 0, E= 0, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N= 0, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday=+1, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday=+1, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected= 0, AToday= 0, DDToday= 0, DailyInc = 0 , Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest =+1))
         ...
         , Sin = list("rate = (tomorrows_adm - AToday > 0) ? 1e6 : 0;"
                      , c(S=+1, E= 0, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested=+1, N=+1, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom=+1, Ninfected= 0, AToday=+1, DDToday= 0, DailyInc = 0 , Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         
         , Sout = list("rate = (tomorrows_dd - DDToday > 0) ? S*1e6 : 0;"
                       , c(S=-1, E= 0, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested=-1, N=-1, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected= 0, AToday= 0, DDToday=+1, DailyInc = 0 , Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         , Eout = list("rate = (tomorrows_dd - DDToday > 0) ? E*1e6 : 0;"
                       , c(S= 0, E=-1, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested=-1, N=-1, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday=+1, DailyInc = 0 , Undetected =+1, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         , Esout = list("rate = (tomorrows_dd - DDToday > 0) ? Es*1e6 : 0;"
                        , c(S= 0, E= 0, Es=-1, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested=-1, N=-1, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday=+1, DailyInc = 0 , Undetected =+1, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis =+1, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
         , Eaout = list("rate = (tomorrows_dd - DDToday > 0) ? Ea*1e6 : 0;"
                        , c(S= 0, E= 0, Es= 0, Ea=-1, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested=-1, N=-1, ST= 0, ET= 0, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT= 0, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday=+1, DailyInc = 0 , Undetected =+1, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis =+1, retest = 0))
         ...
         , ETout = list("rate = (tomorrows_dd - DDToday > 0) ? ET*1e6 : 0;"
                        , c(S= 0, E= 0, Es= 0, Ea= 0, Is= 0, Ia= 0, Rp= 0, R= 0, NUntested= 0, N=-1, ST= 0, ET=-1, EsT= 0, EaT= 0, IsT= 0, IaT= 0, RpT= 0, RT= 0, NT=-1, SToday= 0, EToday= 0, EsToday= 0, EaToday= 0, IsToday= 0, IaToday= 0, RpToday= 0, RToday= 0, NToday= 0, E_toInfect= 0, SAR_numer= 0, SAR_denom= 0, Ninfected=-1, AToday= 0, DDToday=+1, DailyInc = 0 , Undetected = 0, E_untested_dis = 0, sympt_untested_rec = 0, sympt_untested_dis = 0, asympt_untested_rec = 0, asympt_untested_dis = 0, retest = 0))
