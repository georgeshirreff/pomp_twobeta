...
scens <- read_csv("input/sensAnalysis/sensAnalysis_scenarios_v5.csv")
...
# scens <- read_csv("~/Pasteur/tars/input/sensAnalysis/sensAnalysis_scenarios_v5.csv")
...
# b = 1
  ...
  for(i in 1:NTESTS){
    ...
    res %>% write_csv(paste0("output/seirInflect_", experiment_name, "_scennum", scennum, "_startbeta1", start_beta1 , ".csv"))
