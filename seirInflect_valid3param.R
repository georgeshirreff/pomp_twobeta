...
valid_table <- read_csv("input/validation/validation_table_3param.csv")
...
# valid_table <- read_csv("~/Pasteur/tars/input/validation/validation_table_3param.csv")
...
proposal_call = c("rw.sd(beta1 = 0.02, beta_factor = 0.02, E_init = ivp(1), t_init = ivp(0), t_inflect = ivp(0))")
