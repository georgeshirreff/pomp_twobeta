...
valid_table <- read_csv("input/validation/validation_table_3param_beta2.csv")
...
# valid_table <- read_csv("~/Pasteur/tars/input/validation/validation_table_3param_beta2.csv")
...
proposal_call = paste0("rw.sd(beta1 = ifelse(time < ", true_parameters["t_inflect"], ", 0.02, 0), beta2 = ifelse(time >= ", true_parameters["t_inflect"], ", 0.02, 0), E_init = ivp(1), t_init = ivp(0), t_inflect = ivp(0))")
...
NTESTS = 10
Nmif = 1000 #500 #2000 #100
mif2_Np = 500 #10000


lik_Np = 10
lik_rep = 2
cooling.fraction = 0.9 #0.8 #0.5
