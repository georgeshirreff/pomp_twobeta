...
valid_table <- read_csv("input/validation/validation_table_4paramv3.csv")
...
# valid_table <- read_csv("~/Pasteur/tars/input/validation/validation_table_4paramv3.csv")
...
proposal_call = c("rw.sd(beta1 = 0.02, beta_factor = 0.02, E_init = ivp(1), t_init = ivp(0), t_inflect = ivp(5))")
